...
def run_sim(scheduling_policy, total_gpus, estimate, output_file, from_trace, cdf_app_service_times, cdf_num_jobs_per_app, cdf_max_gpus_per_job, cdf_min_gpus_per_job, load, num_gpus, num_apps, seed):
    app_list = {}
    event_queue = list()
    ...
    if from_trace:
        ...
        gen_workload(cdf_app_service_times,
...
if __name__ == '__main__':
    ...
    cdf_app_service_times = args.cdf_app_service_times
    cdf_num_jobs_per_app = args.cdf_num_jobs_per_app
    cdf_max_gpus_per_job = args.cdf_max_gpus_per_job
    cdf_min_gpus_per_job = args.cdf_min_gpus_per_job
    load = args.load
    num_gpus = args.num_gpus
    num_apps = args.num_apps
    seed = args.seed
    run_sim(scheduling_policy, total_gpus, estimate, output_file, from_trace, cdf_app_service_times, cdf_num_jobs_per_app, cdf_max_gpus_per_job, cdf_min_gpus_per_job, load, num_gpus, num_apps, seed)
