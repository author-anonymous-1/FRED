...
class AppThemisScheduler(AppGenericScheduler):
    ...
    def __init__(self, total_gpus, event_queue, app_list, quantum=1, app_info_fn="results.csv", suppress_print=False, estimate=False):
        super(AppThemisScheduler, self).__init__(total_gpus, event_queue, app_list, app_info_fn, suppress_print, estimate)
