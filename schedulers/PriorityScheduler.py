...
class AppPrioScheduler(AppGenericScheduler):
    ...
    def __init__(self, total_gpus, event_queue, app_list, prio_func, app_info_fn="results.csv", suppress_print=False, estimate=False):
        super(AppPrioScheduler, self).__init__(total_gpus, event_queue, app_list, app_info_fn, suppress_print, estimate)
